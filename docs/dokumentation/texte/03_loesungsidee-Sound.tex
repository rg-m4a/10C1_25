...
also in kleinen Stücken in den Speicher geladen, verwendet und wieder
...
Schritt müssen die gelesenen Daten an eine Instanz von \texttt{SourceDataLine} übergeben werden. Dazu wird deren \textit{write}-Methode verwendet.