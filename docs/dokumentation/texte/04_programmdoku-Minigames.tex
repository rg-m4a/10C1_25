...
\begin{sloppypar}
    \begin{itemize}
        ...
        \item \texttt{SOLUTIONS}: Ein dreidimensionales \texttt{dosuble}-Array, welches für jede Lösung (erste Dimension), für jeden Tangram-Stein (zweite Dimension) die X-Position, Y-Position und Rotation (dritte Dimension) speichert.
