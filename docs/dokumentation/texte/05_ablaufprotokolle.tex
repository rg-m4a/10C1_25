...
Während des Ziehens kann die Taste \glqq R \grqq{} gedrückt werden, wodurch der Stein um $45^\circ$ im Uhrzeigersinn gedreht wird.
...
Das Minispiel endet, wenn der Countdown abläuft oder das Puzzle gelöst wird.
...
Durch das Treffen des Ziels oder der Kollision mti Wand bzw. Boden endet das Minispiel.
...
Die Zuordnung von Label zu Bild kann man beliebig oft ändern. Dafür sortiert man ein neues Label zu dem schon vergebenen Bild. Das alte Label wird dann zurück in die Auswahl gepackt.
Das Minispiel endet, wenn allen vier Pflanzenbildern ein Label zugeordnet sind.
...
Das Durchführen von Tests im klassischen Sinne, bei denen den Variablen des Programmes Werte durch Eingaben der testenden Person zugewiesen werden, um zu schauen, ob die resultierenden Ausgaben den Erwartungen entsprechen, bietet sich bei diesem Projekt nicht an und ist teilweise sogar unmöglich.
