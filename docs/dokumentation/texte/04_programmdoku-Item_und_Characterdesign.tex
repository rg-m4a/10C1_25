...
Der lezte Teil benutzt eine Folge von if-else-Abfragen, um den Lehrern im Kampf ihr Items zuzuweisen. Diese fragen zuerst nach der Fachschaft des Lehrers/der Lehrerin und stellen diesen dann einen Pool aus Items bereit, welche sie dann im Kampf verwenden können.
\\
\begin{lstlisting}
